...
public class GridExplorerPolicyIterator extends OOMDPPlanner implements
		QComputablePlanner {
	...
	public GridExplorerPolicyIterator(Domain domain, RewardFunction rf,
	...
	public static void main(String[] args) {
		...
		RewardFunction rf = new GoalBasedRF(new TFGoalCondition(tf), 85, -1);
		...
		GridExplorerPolicyIterator tester = new GridExplorerPolicyIterator(
				domain,
				rf,
				tf,
				0.99,
		...
		OOMDPPlanner planner = new PolicyIteration(domain, rf, tf, 0.99, tester.hashingFactory, 0.001, 100, 100);
		...
		System.out.println("Policy iteration learned : ");
