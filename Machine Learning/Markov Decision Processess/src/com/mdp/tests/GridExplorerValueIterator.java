...
public class GridExplorerValueIterator extends OOMDPPlanner implements
		QComputablePlanner {
	...
	public GridExplorerValueIterator(Domain domain, RewardFunction rf,
	...
	public static void main(String[] args) {
		...
		double movementProbability = 1; // only go in intended directon p% of
										// the time
		gwd.setProbSucceedTransitionDynamics(movementProbability);
		...
		// all transitions return -1 for UniformCostRF
		// RewardFunction rf = new UniformCostRF();
		RewardFunction rf = new GoalBasedRF(new TFGoalCondition(tf), 75, -1);
		...
		GridExplorerValueIterator tester = new GridExplorerValueIterator(
				domain,
				rf,
				tf,
				0.99,
		...
		System.out.println("Value iteration learned : ");
		...
		// tester.valueFunctionVisualize((QComputablePlanner)planner, p, s);
